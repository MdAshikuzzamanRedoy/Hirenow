...
@media screen and (max-width: 600px) {
  .col-25, .col-75, input[type=submit] {
	...
	<form  method="post" onsubmit="return validate();" action="../../Controller/admincontroller.php" enctype="multipart/form-data">
	<center><h1 style="color:yellow">InBox</h1></center>
