...
<div class="row">
  <div class="col-xs-12 col-sm-9">
    <form class="form-horizontal" method="post" action="../../Controller/employeeupdate.php" onsubmit="return validation()" enctype="multipart/form-data" >
      ...
      <div class="panel panel-default">
        ...
        <h4 class="panel-title">Employee Status Update</h4>
        </div>
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="name" id="user" value="<?php echo $data["Name"]?>" class="form-control">
            </div>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="test" id="pass" name="npass"value="<?php echo $data["status"]?>" class="form-control"readonly>
            </div>
          ...
          <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
              <button type="submit" name="Updatestatus" class="btn btn-primary">Change Status</button>
