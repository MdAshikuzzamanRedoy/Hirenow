...
if($query="SELECT count(sl) AS total FROM hirereq where status='pending' and payment='none'"){
...
<div class="main-section">
          <div class="dashbord dashbord-red">
            <div class="icon-section">
              ...
              <p>You Have <?php echo $Ao ; ?> User Request</p>
            </div>
            <div class="detail-section">
              <a href="userrequest.php">View All </a>
            </div>
          </div>
