...
<div class="row">
  <div class="col-xs-12 col-sm-9">
    <form class="form-horizontal" method="post" action="../../Controller/modaratorupdate.php" onsubmit="return validation()" enctype="multipart/form-data" >
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="namee" id="user" value="<?php echo $data["username"]?>" class="form-control">
            </div>
