...
$password = "";
$dbname = "hirenow";
 $ver=$_SESSION["loggedinuser"];
// Create connection
$conn = mysqli_connect($servername, $username, $password, $dbname);

if($query="SELECT count(sl) AS total FROM hirereq where status='ongoing' and username='$ver'"){
...
<div class="main-section">
          <div class="dashbord dashbord-red">
            <div class="icon-section">
              ...
              <p>You Have <?php echo $Ao ; ?> Ongoing Work</p>
            </div>
            <div class="detail-section">
              <a href="ongoingservices.php">View All </a>
            </div>
          </div>
